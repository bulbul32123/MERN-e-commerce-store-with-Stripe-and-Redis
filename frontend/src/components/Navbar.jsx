...
const Navbar = () => {
    const { user, logout, upgradeUser, checkAuth } = useUserStore();
    ...
    const handleChangeToAdmin = async () => {
        ...
        if (!success) {
            toast.success("Failed to upgrade user.");
        }
        setIsAdmin(true)
        toast.success("congratulations You Become an Admin")
    };
                    ...
                    <nav className='flex flex-wrap items-center gap-4'>
                        ...
                        {isAdmin && (
                            ...
                            >
                                ...
                                <button onClick={() => checkAuth()} className="hidden sm:inline">Dashboard</button>
                            </Link>
                        )}
                        {user && !isAdmin && (
                            <button
                            ...
                            >
                                <span className="hidden sm:inline ml-2">Become Admin</span>
                            </button>
                        )}
                        {user ? (
                            <button
